...
-- [3] 주문 초기 데이터 (orders)
-- ============================================================================
INSERT INTO orders (id, buyer_id, receiver_id, receiver_phone, product_id, total_price, payment_status, gift_message, created_at, updated_at) VALUES
(1, 1, 2, '01098765432', 1, 5000, 'paid', '춘향아, 내일 익산 시내 투어할 때 이 버스 패스로 편하게 이동해!', '2026-07-01 10:00:00', '2026-07-01 10:00:00'),
(2, 3, 1, '01012345678', 5, 45000, 'paid', '길동아, 이번 달 통학 편하게 하라고 정기권 보낸다.', '2026-07-02 14:30:00', '2026-07-02 14:30:00'),
(3, 2, 3, '01055556666', 3, 12000, 'paid', '몽룡 도령, 이번 주말 KTX 타고 익산역 올 때 요긴하게 쓰셔요.', '2026-07-03 09:15:00', '2026-07-03 09:15:00');
